    ...
    <div className="stats-table" testid="stateWiseCovidDataTable">
      <div className="table-header">
        ...
        <div className="table-column">
          <p className="table-header-tilte">Confirmed</p>
        </div>
        <div className="table-column">
          <p className="table-header-tilte">Active</p>
        </div>
        <div className="table-column">
          <p className="table-header-tilte">Recovered</p>
        </div>
        <div className="table-column">
          <p className="table-header-tilte">Deceased</p>
        </div>
        <div className="table-column">
          <p className="table-header-tilte">Population</p>
        </div>
      </div>
      <hr className="line" />
